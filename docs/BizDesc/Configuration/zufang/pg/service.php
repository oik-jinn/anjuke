...
$config['allLuceneRentUriList']  =  array(
        11      => "http://solr.anjuke.test:8983/haozu-list-11/select?",
        14      => "http://solr.anjuke.test:8983/haozu-list-14/select?",
        "other" => "http://solr.anjuke.test:8983/haozu-list-03/select?",
        "four"  => "http://solr.anjuke.test:8983/haozu-list-04/select?"
 );
*/
